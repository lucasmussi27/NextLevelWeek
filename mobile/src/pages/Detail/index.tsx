...
import { 
  Feather as Icon, FontAwesome 
} from "@expo/vector-icons";
import { 
  View, StyleSheet, TouchableOpacity,
  Image, Text, SafeAreaView, Linking
} from "react-native";
...
const Detail = () => {
  ...
  const handleNavigateToPoints = () => navigation.goBack();
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <View style={styles.address}>
          <Text style={styles.addressTitle}>Rua do Mercado</Text>
